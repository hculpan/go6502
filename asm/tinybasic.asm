...
;
; Disassembly provided by Dwight Elvey (dwight.elvey@amd.com) after
...
; 0030-007F       Input line buffer & Computation stack
;
EXPRESS_STACK_SIZE	equ	$50
ExpressStack	ds	EXPRESS_STACK_SIZE
ExpressStackTop	equ	*
;
; 0080-0081       Random Number Generator workspace
;
...
Variables	ds	26*2
		...
		org	$b6
Temp2		ds	2	;$b6 - Another 16 bit temp
Dest		ds	2	;destination for memory moves
		ds	2	;$ba - ???
Temp1		ds	2	;$bc temp 16 bit value for many routines
;
...
ExStackBottm	ds	1
ExStackPtr	ds	2
pp_temp		ds	1		;another temp for peek/poke
		ds	2
GosubStkPtr	ds	2		;Gosub stack pointer
;
;**********************************************************************
;
		code
...
;
il_dispatch
	dw	L004		; 2162 - BR ($40 - $5F)
	dw	L005		; 2164 - BR ($60 - $7F)
	dw	DoBC		; 21D8 - BC ($80 - $9F) 
	dw	DoBV		; 2205 - BV ($A0 - $BF)
	dw	DoBN		; 2233 - BN ($C0 - $DF)
	dw	DoBE		; 21FD - BE ($E0 - $FF)
;
	dw	DoNoOp		; 239F - NO ($08)
	dw	DoLB		; 2742 - LB n ($09)
	dw	DoLN		; 273F - LN ($0a)
	dw	DoDS		; 237A - DS ($0b)
	dw	DoSP		; 24FC - SP ($0c)
	dw	PopExByte	; 2395
	dw	DoNoOp		; 239F - Undefined
	dw	DoNoOp		; 239F - Undefined
	dw	DoSB		; 26BD - SB ($10)
	dw	DoRB		; 26C1 - RB ($11)
	dw	DoFV		; 268A - FV ($12)
	...
	dw	DoNoOp		; 239F - Undefined
	dw	DoGL		; 24A8 - GL ($27)
	dw	L037	; 274F - Beats me... I don't see this opcode in C version
	dw	L038	; 274D - Beats me... same excuse
	dw	DoIL		; 2507 - IL ($2a)
	dw	DoMT		; 20AA - MT ($2b)
	dw	DoXQ		; 2337 - XQ ($2c)
	dw	WarmEntry	; 20BD - WS ($2d)
	dw	DoUS		; 271B - US ($2e)
	dw	DoRT		; 26B1 - RT ($2f)
;
AtMsg	db	" AT "
...
;
	db	$24,$3A,$91,$27,$10,$E1,$59,$C5,$2A,$56,$10,$11,$2C,$8B,$4C,$45
	db	$D4,$A0,$80,$BD,$30,$BC,$E0,$13,$1D,$94,$47,$CF,$88,$54,$CF,$30
	db	$BC,$E0,$10,$11,$16,$80,$53,$55,$C2,$30,$BC,$E0,$14,$16,$90,$50
	db	$D2,$83,$49,$4E,$D4,$E5,$71,$88,$BB,$E1,$1D,$8F,$A2,$21,$58,$6F
	db	$83,$AC,$22,$55,$83,$BA,$24,$93,$E0,$23,$1D,$30,$BC,$20,$48,$91
	db	$49,$C6,$30,$BC,$31,$34,$30,$BC,$84,$54,$48,$45,$CE,$1C,$1D,$38
	db	$0D,$9A,$49,$4E,$50,$55,$D4,$A0,$10,$E7,$24,$3F,$20,$91,$27,$E1
	db	$59,$81,$AC,$30,$BC,$13,$11,$82,$AC,$4D,$E0,$1D,$89,$52,$45,$54
	db	$55,$52,$CE,$E0,$15,$1D,$85,$45,$4E,$C4,$E0,$2D,$98,$4C,$49,$53
	db	$D4,$EC,$24,$00,$00,$00,$00,$0A,$80,$1F,$24,$93,$23,$1D,$30,$BC
	db	$E1,$50,$80,$AC,$59,$85,$52,$55,$CE,$38,$0A,$86,$43,$4C,$45,$41
	db	$D2,$2B,$84,$52,$45,$CD,$1D,$A0,$80,$BD,$38,$14,$85,$AD,$30,$D3
	db	$17,$64,$81,$AB,$30,$D3,$85,$AB,$30,$D3,$18,$5A,$85,$AD,$30,$D3
	db	$19,$54,$2F,$30,$E2,$85,$AA,$30,$E2,$1A,$5A,$85,$AF,$30,$E2,$1B
	db	$54,$2F,$98,$52,$4E,$C4,$0A,$80,$80,$12,$0A,$09,$29,$1A,$0A,$1A
	db	$85,$18,$13,$09,$80,$12,$01,$0B,$31,$30,$61,$72,$0B,$04,$02,$03
	db	$05,$03,$1B,$1A,$19,$0B,$09,$06,$0A,$00,$00,$1C,$17,$2F,$8F,$55
	db	$53,$D2,$80,$A8,$30,$BC,$31,$2A,$31,$2A,$80,$A9,$2E,$2F,$A2,$12
	db	$2F,$C1,$2F,$80,$A8,$30,$BC,$80,$A9,$2F,$83,$AC,$38,$BC,$0B,$2F
	db	$80,$A8,$52,$2F,$84,$BD,$09,$02,$2F,$8E,$BC,$84,$BD,$09,$93,$2F
	db	$84,$BE,$09,$05,$2F,$09,$91,$2F,$80,$BE,$84,$BD,$09,$06,$2F,$84
	db	$BC,$09,$95,$2F,$09,$04,$2F,$00,$00,$00
	else
IL_6502	equ	false
				...
				;.
	db	$24,$3a,$91  	;:STRT PC ":Q^"        COLON, X-ON
	db	$27		;      GL
	db	$10		;      SB
	db	$e1		;      BE L0           BRANCH IF NOT EMPTY
	db	$59		;      BR STRT         TRY AGAIN IF NULL LINE
	db	$c5		;:L0   BN STMT         TEST FOR LINE NUMBER
	db	$2a		;      IL              IF SO, INSERT INTO PROGRAM
	db	$56		;      BR STRT         GO GET NEXT
	db	$10		;:XEC  SB              SAVE POINTERS FOR RUN WITH
	db	$11		;      RB                CONCATENATED INPUT
	db	$2c		;      XQ
				;.
				;.  STATEMENT EXECUTOR
				;.
	db	$8b,$4c,$45,$d4	;:STMT BC GOTO "LET"
	db	$a0		;      BV *            MUST BE A VARIABLE NAME
	db	$80,$bd		;      BC * "="
	db	$30,$bc		;:LET  JS EXPR         GO GET EXPRESSION
	db	$e0		;      BE *            IF STATEMENT END,
	db	$13		;      SV                STORE RESULT
	db	$1d		;      NX
				;.
	db	$94,$47,$cf	;:GOTO BC PRNT "GO"
	db	$88,$54,$cf	;      BC GOSB "TO"
	db	$30,$bc		;      JS EXPR         GET LINE NUMBER
	db	$e0		;      BE *
	db	$10		;      SB              (DO THIS FOR STARTING)
	db	$11		;      RB
	db	$16		;      GO              GO THERE
				;.
	db	$80,$53,$55,$c2	;:GOSB BC * "SUB"      NO OTHER WORD BEGINS "GO..."
	db	$30,$bc		;      JS EXPR
	db	$e0		;      BE *
	if	IL_6502
	db	$14		;      ???
	...
	db	$16		;      GO
				;.
	db	$90,$50,$d2	;:PRNT BC SKIP "PR"
	db	$83,$49,$4e,$d4	;      BC P0 "INT"     OPTIONALLY OMIT "INT"
	db	$e5		;:P0   BE P3
	db	$71		;      BR P6           IF DONE, GO TO END
	db	$88,$bb		;:P1   BC P4 ";"
	db	$e1		;:P2   BE P3
	db	$1d		;      NX              NO CRLF IF ENDED BY ; OR ,
	db	$8f,$a2		;:P3   BC P7 '"'
	db	$21		;      PQ              QUOTE MARKS STRING
	db	$58		;      BR P1           GO CHECK DELIMITER
	db	$6f		;:SKIP BR IF           (ON THE WAY THRU)
	db	$83,$ac		;:P4   BC P5 ","
	db	$22		;      PT              COMMA SPACING
	db	$55		;      BR P2
	db	$83,$ba		;:P5   BC P6 ":"
	db	$24,$93		;      PC "S^"         OUTPUT X-OFF
	db	$e0		;:P6   BE *
	db	$23		;      NL              THEN CRLF
	db	$1d		;      NX
	db	$30,$bc		;:P7   JS EXPR         TRY FOR AN EXPRESSION
	db	$20		;      PN
	db	$48		;      BR P1
				;.
	db	$91,$49,$c6	;:IF   BC INPT "IF"
	db	$30,$bc		;      JS EXPR
	db	$31,$34		;      JS RELO
	db	$30,$bc		;      JS EXPR
	db	$84,$54,$48	;      BC I1 "THEN"    OPTIONAL NOISEWORD
	db	$45,$ce
				;
	db	$1c		;:I1   CP              COMPARE SKIPS NEXT IF TRUE
	db	$1d		;      NX              FALSE.
	db	$38,$0d		;      J STMT          TRUE. GO PROCESS STATEMENT
				;.
	db	$9a,$49,$4e	;:INPT BC RETN "INPUT"
	db	$50,$55,$d4
	db	$a0		;:I2   BV *            GET VARIABLE
	db	$10		;      SB              SWAP POINTERS\
	db	$e7		;      BE I4
	db	$24,$3f,$20,$91	;:I3   PC "? Q^"       LINE IS EMPTY; TYPE PROMPT
	db	$27		;      GL              READ INPUT LINE


	db	$e1		;      BE I4           DID ANYTHING COME?
	db	$59		;      BR I3           NO, TRY AGAIN
	db	$81,$ac		;:I4   BC I5 ","       OPTIONAL COMMA
	db	$30,$bc		;:I5   JS EXPR         READ A NUMBER
	db	$13		;      SV              STORE INTO VARIABLE
	db	$11		;      RB              SWAP BACK
	db	$82,$ac		;      BC I6 ","       ANOTHER?
	db	$4d		;      BR I2           YES IF COMMA
	db	$e0		;:I6   BE *            OTHERWISE QUIT
	db	$1d		;      NX
				;.
	db	$89,$52,$45,$54	;:RETN BC END "RETURN"
	db	$55,$52,$ce
	db	$e0		;      BE *
	db	$15		;      RS              RECOVER SAVED LINE
	db	$1d		;      NX
				;.
	db	$85,$45,$4e,$c4	;:END  BC LIST "END"
				;
	db	$e0		;      BE *
	db	$2d		;      WS
				;.
	db	$98,$4c,$49,$53	;:LIST BC RUN "LIST"
	db	$d4
				;
	db	$ec		;      BE L2
	db	$24,$00,$00,$00	;:L1   PC "@^@^@^@^J^@^" PUNCH LEADER
	db	$00,$0a,$80
				;.
	db	$1f		;      LS              LIST
	db	$24,$93		;      PC "S^"         PUNCH X-OFF
	db	$23		;      NL
	db	$1d		;      NX
	db	$30,$bc		;:L2   JS EXPR         GET A LINE NUMBER
	db	$e1		;      BE L3
	db	$50		;      BR L1
	db	$80,$ac		;:L3   BC * ","        SEPARATED BY COMMAS
	db	$59		;      BR L2
				;.
	db	$85,$52,$55,$ce	;:RUN  BC CLER "RUN"
				;
	db	$38,$0a		;      J XEC
				;.
	db	$86,$43,$4c,$45	;:CLER BC REM "CLEAR"
	db	$41,$d2
				;
	db	$2b		;      MT
				;.
	db	$84,$52,$45,$cd	;:REM  BC DFLT "REM"
				;
	db	$1d		;      NX
				;.
	db	$a0		;:DFLT BV *            NO KEYWORD...
	db	$80,$bd		;      BC * "="        TRY FOR LET
	db	$38,$14		;      J LET           IT'S A GOOD BET.
				;.
				;.  SUBROUTINES
				;.
	db	$85,$ad		;:EXPR BC E0 "-"       TRY FOR UNARY MINUS
	db	$30,$d3		;      JS TERM         AHA
	db	$17		;      NE
	db	$64		;      BR E1
	db	$81,$ab		;:E0   BC E4 "+"       IGNORE UNARY PLUS
	db	$30,$d3		;:E4   JS TERM
	db	$85,$ab		;:E1   BC E2 "+"       TERMS SEPARATED BY PLUS
	db	$30,$d3		;      JS TERM
	db	$18		;      AD
	db	$5a		;      BR E1
	db	$85,$ad		;:E2   BC E3 "-"       TERMS SEPARATED BY MINUS
	db	$30,$d3		;      JS TERM
	db	$19		;      SU
	db	$54		;      BR E1
	db	$2f		;:E3   RT
				;.
	db	$30,$e2		;:TERM JS FACT
	db	$85,$aa		;:T0   BC T1 "*"       FACTORS SEPARATED BY TIMES
	db	$30,$e2		;      JS FACT
	db	$1a		;      MP
	db	$5a		;      BR T0
	db	$85,$af		;:T1   BC T2 "/"       FACTORS SEPARATED BY DIVIDE
	db	$30,$e2		;      JS  FACT
	db	$1b		;      DV
	db	$54		;      BR T0
	db	$2f		;:T2   RT
				;.
	if	IL_6502
	db	$98,$52,$4e,$c4	;:FACT BC F0 "RND"     *RND FUNCTION*
	else
	db	$97,$52,$4e,$c4	;:FACT BC F0 "RND"     *RND FUNCTION*
	endif
				;
	db	$0a,$80,$80	;      LN 257*128      STACK POINTER FOR STORE
				;
	db	$12		;      FV              THEN GET RNDM
	db	$0a,$09,$29	;      LN 2345         R:=R*2345+6789
				;
	db	$1a		;      MP
	db	$0a,$1a,$85	;      LN 6789
				;
	db	$18		;      AD
	db	$13		;      SV
	db	$09,$80		;      LB 128          GET IT AGAIN
	db	$12		;      FV
	if	IL_6502
	db	$01
	endif
	db	$0b		;      DS
	db	$31,$30		;      JS FUNC         GET ARGUMENT
	db	$61		;      BR F1
	if	IL_6502
	db	$72		;:F0   BR F2           (SKIPPING)
	else
	db	$73		;:F0   BR F2           (SKIPPING)
	endif
	db	$0b		;:F1   DS
;	db	$02		;      SX 2            PUSH TOP INTO STACK
	db	$04		;      SX 4
	db	$02		;      SX 2
	db	$03		;      SX 3
	db	$05		;      SX 5
	db	$03		;      SX 3
	db	$1b		;      DV              PERFORM MOD FUNCTION
	db	$1a		;      MP
	db	$19		;      SU
	db	$0b		;      DS              PERFORM ABS FUNCTION
	db	$09,$06		;      LB 6
	db	$0a,$00,$00	;      LN 0
				;
	db	$1c		;      CP              (SKIP IF + OR 0)
	db	$17		;      NE
	db	$2f		;      RT
	db	$8f,$55,$53,$d2	;:F2   BC F3 "USR"     *USR FUNCTION*
				;
	db	$80,$a8		;      BC * "("        3 ARGUMENTS POSSIBLE
	db	$30,$bc		;      JS EXPR         ONE REQUIRED
	db	$31,$2a		;      JS ARG
	db	$31,$2A		;      JS ARG
	db	$80,$a9		;      BC * ")"
	db	$2e		;      US              GO DO IT
	db	$2f		;      RT
	db	$a2		;:F3   BV F4           VARIABLE?
	db	$12		;      FV              YES.  GET IT
	db	$2f		;      RT
	db	$c1		;:F4   BN F5           NUMBER?\n");
	db	$2f		;      RT              GOT IT.
	db	$80,$a8		;:F5   BC * "("        OTHERWISE MUST BE (EXPR)
	db	$30,$bc		;:F6   JS EXPR
	db	$80,$a9		;      BC * ")"
	db	$2f		;      RT
				;.
	db	$83,$ac		;:ARG  BC A0 ","        COMMA?
	db	$38,$bc		;      J  EXPR          YES, GET EXPRESSION
	db	$0b		;:A0   DS               NO, DUPLICATE STACK TOP
	db	$2f		;      RT
				;.
	db	$80,$a8		;:FUNC BC * "("
	db	$52		;      BR F6
	db	$2f		;      RT
				;.
	db	$84,$bd		;:RELO BC R0 "="        CONVERT RELATION OPERATORS
	db	$09,$02		;      LB 2             TO CODE BYTE ON STACK
	db	$2f		;      RT               =
	db	$8e,$bc		;:R0   BC R4 "<"
	db	$84,$bd		;      BC R1 "="
	if	IL_6502
...
;
;**********************************************************************
; This is a KIM function to emulate the BREAK key detection.  Tom had
; this in the original TB user manual.
;
	if	KIM1
KTTY	equ	$1740
	org	$0100
